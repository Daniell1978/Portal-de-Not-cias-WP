<?php get_header(); ?>
			...
			<div class="w50 time-descricao">
				...
				<a target="_blank" href="<?php echo get_theme_root_uri(); ?>/dani/https://dankicode.com">Ver demonstração</a>
			</div><!--w50-->
			<div class="w50 time-imagem">
				<img src="<?php echo get_theme_root_uri(); ?>/dani/images/equipe.png" />
			</div><!--w50-->
			<div class="clear"></div>
		</div><!--center-->
	</section><!--topo-->
	...
	<section class="clientes-slider">
		...
		<div style="max-width: 700px;margin: 0 auto;overflow: hidden;" class="slider-container">
			<img src="<?php echo get_theme_root_uri(); ?>/dani/images/amazon.png" />
			<img src="<?php echo get_theme_root_uri(); ?>/dani/images/costco.png" />
			<img src="<?php echo get_theme_root_uri(); ?>/dani/images/dominos.png" />
			<img src="<?php echo get_theme_root_uri(); ?>/dani/images/uber.png" />
			<img src="<?php echo get_theme_root_uri(); ?>/dani/images/walmart.png" />
			...
			<div class="center">
				...
				<div class="icons-diferenciais">
					...
					<div class="box-single-diferenciais">
						<img src="<?php echo get_theme_root_uri(); ?>/dani/images/icon1.png" />
					...
					<div class="box-single-diferenciais">
						<img src="<?php echo get_theme_root_uri(); ?>/dani/images/icon2.png" />
						<h3>Ambientes Mobile</h3>
						<p>Garanta que toda sua comunicação esteja alinhada com seu propósito, cada palavra conta.</p>
					</div><!--box-single-diferenciais-->

					<div class="box-single-diferenciais">
						<img src="<?php echo get_theme_root_uri(); ?>/dani/images/icon3.png" />
						<h3>Ambientes Mobile</h3>
						<p>Garanta que toda sua comunicação esteja alinhada com seu propósito, cada palavra conta.</p>
					</div><!--box-single-diferenciais-->
	...
	<section class="sobre-time">
		<div class="center">
			...
			<div class="w50 img-time">
				<img src="<?php echo get_theme_root_uri(); ?>/dani/images/time.png" />
			</div>
			<div class="clear"></div>
		</div>
	</section>
		...
		<div class="center">
			...
			<div class="depoimentos-box">
				<div class="depoimento-single">
					...
					<img src="<?php echo get_theme_root_uri(); ?>/dani/images/autor.png" />
